...
- [ ] Scaffold Flutter + Supabase (ver `prioridade/atual.md`)
- [ ] Fork de `ocorrencias` (ex-`denuncias` do SIGAU)
- [ ] Fork de `ordens_de_servico` (ex-`resgates` do SIGAU + checklist do Confia)
- [ ] Dashboard básico (KPIs + mapa) pro gestor
- [ ] Edge Function `classify-ocorrencia` (IA, padrão polimata-concursos)
- [ ] Edge Function `insight-dashboard` (resumo executivo por IA)

## Pendências de decisão

- [ ] Escopo do protótipo pro pitch (full app vs. mockup navegável)
